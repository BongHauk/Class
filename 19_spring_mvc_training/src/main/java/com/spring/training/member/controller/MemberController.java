...
public class MemberController {
	...
	@ResponseBody
	public String modifyMember(MultipartHttpServletRequest multipartRequest , HttpServletRequest request) throws Exception {
	...
	@ResponseBody
	public String removeMember(MemberDTO memberDTO , HttpServletRequest request) throws Exception {
