...
class Client{
	...
	void printData() {
		System.out.println(this.id  + " / " + this.passwd + " / " + this.name + " / " + this.birth + " / " + 
	                       this.age + " / " + this.contact + " / " + this.address);
	}
...
public class ObjectArrayEx05_연습 {
	...
	public static void main(String[] args) {
		...
		//after
		clientList[1].setData("user2" , "2222" , "사용자2" , "2000-01-01" , 24 , "010-2222-2222" , "부산");
		clientList[2].setData("user3" , "3333" , "사용자3" , "2010-01-01" , 24 , "010-3333-3333" , "인천");
