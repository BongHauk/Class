package com.application.bms.admin.order.controller;
...
import com.application.bms.admin.order.service.AdminOrderService;
...
public class AdminOrderController {
	...
	public void orderExcelExport(HttpServletResponse response) throws Exception {
		...
		for (Map<String,Object> orderMap :  adminOrderService.getOrderList()) {
	        ...
	        cell = row.createCell(5);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((String)orderMap.get("writer"));
	        cell = row.createCell(6);
	        cell.setCellStyle(bodyStyle);
	        cell.setCellValue((String)orderMap.get("publisher"));
	        cell = row.createCell(7);
	        cell.setCellStyle(bodyStyle);
