...
<body>
                            ...
                            <ul class="navbar-nav mx-auto fables-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="sub-nav3">
                                        ...
                                        <li><a class="dropdown-item" href="../board.contri/ContriList.jsp">기고글 둘러보기</a></li>
    ...
    <div class="board_wrap">
        <div class="board_title">
            <strong>질문있어요!</strong>
            <div class="listbtn">
                <button onclick="listPage()">목록보기</button>
            </div>
        </div>
            ...
            <div class="board_write">
                ...
                <div class="cont">
                    <dl>
                        ...
                        <h5><br>&nbsp&nbsp&nbsp&nbsp 알려줘</h5>
   ...
   <div class="board_wrap">
        ...
        <div class="board_write_wrap">
            <div class="board_write">
                <div class="title">
                    <dl>
                        <dd><input type="text" placeholder="웹페이지 어떻게 만들어요?" readonly></dd>
                    </dl>
                </div>
            ...
            <div class="bt_wrap">
                ...
                <a href="http://127.0.0.1:5501/Q&Aboard.html">취소</a>
            </div>
        </div>
    </div>
</div>
