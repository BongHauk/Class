...
.right-align {
    ...
    #ulTable > li > ul > li:first-child               {width:50%;} /*제목 열 크기*/
        #ulTable > li > ul > li:first-child +li           {width:20%;} /*닉네임 열 크기*/
        #ulTable > li > ul > li:first-child +li+li        {width:10%;} /*좋아요수 열 크기*/
        #ulTable > li > ul > li:first-child +li+li+li     {width:10%;} /*조회수 열 크기*/
        #ulTable > li > ul > li:first-child +li+li+li+li{width:10%;} /*날짜 열 크기*/
...
<body>
                            ...
                            <ul class="navbar-nav mx-auto fables-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="sub-nav3">
                                        <!-- href 수정 필요 -->
                                        <li><a class="dropdown-item" href="../boardfree/freelist.jsp">자유게시판</a></li>
                                        <li><a class="dropdown-item" href="../boardcontri/contrilist.jsp">기고글 둘러보기</a></li>
    ...
    <div class="board_wrap">
        ...
        <li>
                ...
                <li>
                    <ul>
                        <li><a href="../board.qna/QnaView.jsp">웹페이지 어떻게 만들어요?</a></li>
                        <li>홍길동</li>
                        <li>0</li>
                        <li>0</li>
                        <li>2023.07.08</li>
        ...
        <div class="write">
        <button onclick="awritePage()">글쓰기</button>
    </div>
        <!-- 게시판 페이징 영역 -->
