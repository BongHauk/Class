                            ...
                            <ul class="navbar-nav mx-auto fables-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="sub-nav3">
                                        <!-- href 수정 필요 -->
                                        <li><a class="dropdown-item" href="../board.free/FreeList.jsp">자유게시판</a></li>
                                        <li><a class="dropdown-item" href="../board.contri.model/ContriList.jsp">기고글 둘러보기</a></li>
...
<div class="fables-header fables-after-overlay">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Security</h2>
    </div>
</div>  
<!-- /End Header -->
...
<div class="total">
    <div class="board_wrap">
        <div class="board_title">
            <strong>기고글 둘러보기</strong>
        </div>

        <div class="board_write_wrap">
            <form name="writeFrm" method="post" action="../mvcboard/contriedit.do"
                ...
                <div class="bt_wrap">
                    ...
                    <li>
                        <button type="button" onclick="location.href='../mvcboard/contri.do';">
                            취소
                        </button>
                    </li>
                </div>
...
<script>
    function writePage() {
        window.location.href = "http://127.0.0.1:5501/write.html";
    }
</script>
