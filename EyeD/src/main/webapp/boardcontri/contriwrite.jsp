...
<head>
    ...
    <%--글쓰기--%>
    <link rel="stylesheet" type="text/css" href="../assets/summernote-0.8.18-dist/summernote-lite.css"/>
    <!-- animate.css-->
    ...
    <div class="board_wrap">
        ...
        <div class="board_write_wrap">
            <form name="writeFrm" method="post"
                  action="../mvcboard/contriwrite.do" onsubmit="return validateForm(this);">
...
<script>
    ...
    <script type="text/javascript" src="../assets/summernote-0.8.18-dist/summernote-lite.js"></script>
