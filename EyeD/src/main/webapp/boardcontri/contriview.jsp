...
<div class="total">
    <div class="board_wrap">
        <div class="board_title">
            ...
            <div class="list">
                <button type="button" onclick="location.href='../mvcboard/contri.do';">목록보기</button>
            </div>
        </div>
            ...
            <div class="board_write">
                <div class="title">
                    ...
                    <div class="cont">
                        ...
                        <ul class="editbtn">
                            <li><a href="../mvcboard/contriedit.do?post_num=${param.post_num}">수정하기</a></li>
                            <li><a href="../mvcboard/contridelete.do?post_num=${ param.post_num }">삭제하기</a></li>
                        </ul>
                    </div>
