...
<div class="total">
        ...
        <div class="board_write_wrap">
            <div class="board_write">
                <div class="title">
                    ...
                    <p>${ vo.createdate }</p>
                    <p class="right-align">${ vo.user_id }</p>
                    <br>
                    <br>
                    ...
                    <div class="cont">
                        ...
                        <ul class="editbtn">
                            <li><a href="../mvcboard/edit.do?&post_num=${param.post_num}">수정하기</a></li>
                            <li><a href="../mvcboard/delete.do?&post_num=${ param.post_num }">삭제하기</a></li>
                        </ul>
                    </div>

                    <%--                    <div>--%>
                    <%--                        <button type="button"--%>
                    <%--                                onclick="location.href='../mvcboard/edit.do?&post_num=${ param.post_num }';">--%>
                    <%--                            수정하기--%>
                    <%--                        </button>--%>
                    <%--                        <button type="button"--%>
                    <%--                                onclick="location.href='../mvcboard/delete.do?&post_num=${ param.post_num }';">--%>
                    <%--                            삭제하기--%>
                    <%--                        </button>--%>
                    <%--                    </div>--%>
    ...
    <%--                s.src = 'https://jjang-ah.disqus.com/embed.js';--%>
