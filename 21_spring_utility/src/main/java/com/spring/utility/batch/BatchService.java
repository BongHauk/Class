...
public class BatchService {
	...
	*/
	   ...
	   [ 샘플 예시 ]    
	 	...
	 	@Scheduled(cron="0 0 15 * * *")		     > 매일 15시에 실행 
 	 	@Scheduled(cron="0 30 15 * * *")		 > 매일 15시 30분에 실행 
 	  	@Scheduled(cron="* 0/15 * * * *")		 > 매일 15분 간격으로 실행 (매초마다)
	...
	public void getProductList() throws Exception { // 배치로 사용하는 메서드는 return을 사용할 수 없다.
		
		System.out.println("ex) 13시 배치");
	...
	public void getBrandList() throws Exception {
		...
		System.out.println("ex) 13시 51분 배치");
