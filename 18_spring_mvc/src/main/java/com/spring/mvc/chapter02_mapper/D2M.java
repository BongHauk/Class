...
public class D2M {
	...
	public void sample04() {
		...
		// primary key 데이터 중복 입력 오류 : Duplicate entry 'add1' for key 'brand.PRIMARY'
		//brandDTO.setBrandCd("add1"); 
		// 데이터 길이 오버플로우 오류 :  Data truncation: Data too long for column 'BRAND_CD'
		//brandDTO.setBrandCd("add15글자넘길건데?"); 
