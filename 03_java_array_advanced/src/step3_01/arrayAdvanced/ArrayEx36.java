...
public class ArrayEx36 {
	...
	public static void main(String[] args) {
		...
		System.out.println("arr : " + arr);			// 주소(레퍼런스)
		System.out.println("arr[0] : " + arr[0]);   // 주소(레퍼런스)
		System.out.println("arr[1] : " + arr[1]);   // 주소(레퍼런스)
		System.out.println();
		...
		// 생각해보기
		int[][] temp1 = arr;	    // [주소] or 데이터
		int[] temp2   = arr[0];	    // [주소] or 데이터
		int[] temp3   = arr[1];	    // [주소] or 데이터
		int temp4     = arr[0][0];	// 주소 or [데이터]
		int temp5     = arr[1][1];	// 주소 or [데이터]
