...
// 2) 주석 ( comment ) : 설명문을 작성하기 위한방법으로 프로그램의 실행에 영향을 미치지 않는다.
 ...
 *  
 *  
 *  7) 코드 실행  : ctrl + f11      (f11 : 디버깅 모드)
 *   
 *  
 *  8) 유용한 단축키 
 *  
 * 		8-1) 복사    			  : ctrl + alt + 위 or 아래 방향키
 * 		8-2) 이동     			  : alt + 위 or 아래 방향키
 * 		8-3) 블록잡기 			  : shift + 위 or 아래 방향키
 * 		8-4) 삭제     			  : ctrl + d
 * 	    8-5) 단어 찾기 			  : ctrl + f
 * 	    8-6) 화면 최대화 & 최소화 : ctrl + m
 *  
 * */
...
public class PrintEx01 {
	...
	public static void main(String[] args) { // main 메서드의 {}안에서 프로그래밍을 한다.
		
		// tab으로 들여쓰기한 이후에 코드를 작성한다.
		
		// System.out.println(데이타) : 데이타를 콘솔에 출력한 뒤에 줄을 바꾼다.
		System.out.println("==============");
		System.out.println(" 메뉴 선택");
		System.out.println("==============");
		
		// 출력데이터가 없으면 줄바꿈기능만 적용되어 한줄을 띄운다.
		System.out.println();
		System.out.println();
		...
		// System.out.print(데이터) : 데이타를 콘솔에 출력한 뒤에 줄을 바꾸지 않는다.
