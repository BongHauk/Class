...
public class PrintEx03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("C:\\coupang\\repository");
		 ...
		 */
		Date time1 = new Date();
		System.out.println(time1); // Thu Aug 03 13:05:03 KST 2023
		
		long time2 = System.currentTimeMillis();
		System.out.println(time2); // 1691035843375
		System.out.println();
		...
		int salary1 = 1000000;
		int salary2 = 10000000;
		int salary3 = 100000000;
		
		DecimalFormat df = new DecimalFormat("#,##0");
		String strSalary1 = df.format(salary1);
		
		System.out.println("strSalary1 : " + strSalary1);
		System.out.println("strSalary2 : $" + df.format(salary2));
		System.out.println("strSalary3 : " + df.format(salary3) +"원");
